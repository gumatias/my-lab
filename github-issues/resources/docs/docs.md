...
Request middleware functions are located under the `github-issues.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `github-issues.dev-middleware` namespace found in
