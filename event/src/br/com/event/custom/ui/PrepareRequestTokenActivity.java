...
import br.com.event.custom.infra.OAuthRequestTokenTask;
...
public class PrepareRequestTokenActivity extends Activity {
	...
	public class RetrieveAccessTokenTask extends AsyncTask<Uri, Void, Void> {
		...
		private void executeAfterAccessTokenRetrieval() {
			...
			try {
				TwitterManager manager = new TwitterManager(PrepareRequestTokenActivity.this, prefs);
				manager.sendTweet(prefs, msg);
			} catch (Exception e) {
